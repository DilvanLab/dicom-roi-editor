...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__21055__auto__,writer__21056__auto__,opt__21057__auto__){
return cljs.core._write.call(null,writer__21056__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__22346 = o;
(G__22346[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__22347__delegate = function (args){
...
while (G__22348__i < G__22348__a.length) {G__22348__a[G__22348__i] = arguments[G__22348__i + 0]; ++G__22348__i;}
  args = new cljs.core.IndexedSeq(G__22348__a,0);
} 
return G__22347__delegate.call(this,args);};
...
return G__22347__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__20437__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__20437__auto__){
var and__20437__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__22355 = jsprops;
(G__22355["defaultValue"] = value);

(G__22355["onChange"] = ((function (G__22355,v,value,on_change){
return (function (p1__22352_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22352_SHARP_);
});})(G__22355,v,value,on_change))
);

(G__22355["ref"] = ((function (G__22355,v,value,on_change){
return (function (p1__22353_SHARP_){
return (this$["cljsInputElement"] = p1__22353_SHARP_);
});})(G__22355,v,value,on_change))
);
...
var vec__22362 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22362,(0),null);
var id = cljs.core.nth.call(null,vec__22362,(1),null);
var class$ = cljs.core.nth.call(null,vec__22362,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___22367 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___22367 == null)){
} else {
var key_22368 = temp__4661__auto___22367;
(jsprops["key"] = key_22368);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__22370 = (new reagent.impl.template.NativeWrapper());
(G__22370["name"] = c);
...
var len__21524__auto___22376 = arguments.length;
var i__21525__auto___22377 = (0);
while(true){
if((i__21525__auto___22377 < len__21524__auto___22376)){
args__21531__auto__.push((arguments[i__21525__auto___22377]));

var G__22378 = (i__21525__auto___22377 + (1));
i__21525__auto___22377 = G__22378;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21532__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22374){
var G__22375 = cljs.core.first.call(null,seq22374);
var seq22374__$1 = cljs.core.next.call(null,seq22374);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__22375,seq22374__$1);
});
...
break;
default:
var G__22382 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22382;
continue;
...
var n__21364__auto___22385 = a.length;
var i_22386 = (0);
while(true){
if((i_22386 < n__21364__auto___22385)){
(a[i_22386] = reagent.impl.template.as_element.call(null,(a[i_22386])));

var G__22387 = (i_22386 + (1));
i_22386 = G__22387;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21364__auto___22388 = a.length;
var i_22389 = (0);
while(true){
if((i_22389 < n__21364__auto___22388)){
var val_22390 = (a[i_22389]);
if((cljs.core.vector_QMARK_.call(null,val_22390)) && ((reagent.impl.template.key_from_vec.call(null,val_22390) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22389] = reagent.impl.template.as_element.call(null,val_22390));

var G__22391 = (i_22389 + (1));
i_22389 = G__22391;
continue;
} else {
}
...
var ctx = ({});
var vec__22395 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__22395,(0),null);
var derefed = cljs.core.nth.call(null,vec__22395,(1),null);
...
var G__22399 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22399) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__22399){
...
//# sourceMappingURL=template.js.map?rel=1480335648715